...
## 6.5 Le varianti si approvano

Una variante nasce `da approvare`. Non è un'etichetta: finché non è approvata
**l'ordine non si registra**.

⚠ **L'offerta si può fare comunque.** Quotare è lecito e serve: il commerciale deve
capire se il cliente ci sta. Mandare in produzione un prodotto che nessuno ha
approvato, no.

**Come si chiede** — pulsante `chiedi approvazione` accanto alla pastiglia viola.
La richiesta va sul server, non in una mail: una mail resta nella casella di chi
la legge e il sistema non ne sa niente.

**Come si risponde** — chi approva vede in barra `◈ 2 da approvare`. Apre, legge
variante, prodotto d'origine, cliente e ordine, e preme **approva** o **rifiuta**.
Il rifiuto chiede un motivo, che il commerciale vedrà.

**La scadenza** — la richiesta vale **60 minuti**. Se nessuno risponde, scade e
diventa rossa: il commerciale lo sa e può dire al cliente «le confermo domani»
invece di aspettare al buio. Una richiesta scaduta si può rifare.

⚠ Lo stato si legge **dal server**: il commerciale vede la risposta comparire
mentre è ancora seduto davanti al cliente, senza ricaricare.

| stato | pastiglia | l'ordine si registra? |
|---|---|---|
| da approvare | viola | no |
| in attesa… | ambra | no |
| approvata | petrolio | **sì** |
| rifiutata | ambra scuro, col motivo | no |
| scaduta | ambra scuro | no — si richiede |

⚠ Il tempo di scadenza si cambia nel file: costante `APPROVA_MINUTI`.
...
| **Notifica** a chi approva (mail, messaggio) | non c'è — chi approva controlla la lista |
...
11. **Chiedere l'approvazione e non avvisare nessuno** — il sistema non manda
    notifiche: chi approva deve guardare la lista.
...
**Chi approva le varianti.** La meccanica c'è: richiesta, scadenza a 60 minuti,
approva/rifiuta con motivo. Manca **la persona**: chi controlla la lista, e ogni
quanto. Senza qualcuno che guarda, le richieste scadono e basta.
